...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#301f13]">
      <div className="flex-1 flex flex-col ml-24 mt-24 space-y-6 px-4"> 
        <div className="text-left">
          <Link href="https://github.com/FootHealthProtocol/Building_Apollo/blob/main/_WP_00_index">
            <p className="hover:underline text-green-500 text-4xl">Read the whitepaper</p>
          </Link>
          <br />
          <Link href="https://github.com/FootHealthProtocol/Building_Apollo/blob/main/README.md">
            <p className="hover:underline text-white">View GitHub repository</p>
          </Link>
          <br />
            <p className=" text-white">To offer feedback or propose a change DM us on nostr</p>
        </div>
      </div>

        <div className="pb-8 px-4 text-white">
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8 ml-10">
